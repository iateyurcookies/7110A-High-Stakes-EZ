...
void autonomous() {
  ...
  pros::Task console_display([&]() {   //-------------------------> printing important stuff to the brain
    while (true) {
...
void opcontrol() {
  ...
  pros::Task controller_screen([&]() {  //-------> Prints important stuff to the controller screen
    while (true) { 
...
//---------------------------------------------------------Intake code------------------------------------------------------------------
    ...
    // Pressing L1/L2 will outake :: R1/R2 will intake
